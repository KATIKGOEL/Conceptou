...
const Signup = () => {
  ...
  return (
    <>
    <div className='w-full min-h-[89vh] custom-background bg-cover flex justify-center items-center'>
    <div className="w-full flex justify-center on">
        <div className="w-10/12 flex justify-center mx-auto flex-col my-20">
          ...
          <h1 className="text-3xl mt-2 text-center font-thin">
            Signup to proceed
          </h1>
          <div className=" mx-auto w-3/12 mt-10 mb-1 min-w-fit">
            <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 ">
              <div className="mb-4">
                ...
                <input
                  className="shadow mb-3 appearance-none border rounded w-full text-xs py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  id="name"
                  type="name"
                  name="name"
